"""
YOLO26n-pose DeepX (.dxnn) Predict - Using Ultralytics DeepX Library

Runs inference on a DeepX-exported YOLO26n pose estimation model (.dxnn)
...
def main():
    try:
        ...
        model = YOLO(model=str(MODEL_DIR), task='pose')
