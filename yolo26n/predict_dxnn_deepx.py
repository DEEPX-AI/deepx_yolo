"""
YOLO26n DeepX (.dxnn) Predict - Using Ultralytics DeepX Library

Runs inference on a DeepX-exported YOLO26n detection model (.dxnn)
...
def main():
    try:
        ...
        model = YOLO(model=str(MODEL_DIR), task='detect')
