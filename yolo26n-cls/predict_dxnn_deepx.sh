#!/bin/bash
# YOLO26n-cls DeepX (.dxnn) Predict - CLI
#
# Runs inference on a DeepX-exported YOLO26n classification model using the yolo CLI.
#
# Usage:
...
MODEL_DIR="${SCRIPT_DIR}/yolo26n-cls_deepx_model"
