#!/bin/bash
# YOLO26n-seg DeepX (.dxnn) Predict - CLI
#
# Runs inference on a DeepX-exported YOLO26n segmentation model using the yolo CLI.
#
# Usage:
...
MODEL_DIR="${SCRIPT_DIR}/yolo26n-seg_deepx_model"
