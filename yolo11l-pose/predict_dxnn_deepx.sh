#!/bin/bash
# YOLO11l-pose DeepX (.dxnn) Predict - CLI
#
# Runs inference on a DeepX-exported YOLO11l pose estimation model using the yolo CLI.
#
# Usage:
...
MODEL_DIR="${SCRIPT_DIR}/yolo11l-pose_deepx_model"
