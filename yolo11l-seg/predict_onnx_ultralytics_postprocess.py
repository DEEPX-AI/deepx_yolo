...
def postprocess_segmentation(outputs, orig_img, preproc_shape):
    """
    ...
    Args:
        ...
        preproc_shape: Actual preprocessing shape (H, W) after letterbox - e.g., (640, 640) or (480, 640)
...
def run_inference(model_path, image_path, output_dir, debug=False, save=True, show=False, rect=True):
    ...
    try:
        ...
        result = postprocess_segmentation(outputs, orig_img, preproc_shape)
